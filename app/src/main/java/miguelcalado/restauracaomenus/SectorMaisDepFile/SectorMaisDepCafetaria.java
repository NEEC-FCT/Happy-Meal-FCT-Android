...
public class SectorMaisDepCafetaria extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
...

        {
            ...
            public void onClick(View view) {
                Intent start = new Intent(SectorMaisDepCafetaria.this, MapsActivity.class);
        ...
        try {
            JsonDic myJson = new JsonDic(filename, SectorMaisDepCafetaria.this);
            ...
            cafetariaSets.add(new CafetariaSet("Sector + Dep", myJson, pastelariaTitle,pastelariaAll, pastelariaText, pastelariaPrice, "pastelaria", MAX_TO_SEE));
            ...
            cafetariaSets.add(new CafetariaSet("Sector + Dep", myJson, BebidasTitle ,BebidasAll, BebidasText, BebidasPrice, "bebida", MAX_TO_SEE));
            ...
            cafetariaSets.add(new CafetariaSet("Sector + Dep", myJson,padariaTitle , padariaAll, padariaText, padariaPrice, "padaria", MAX_TO_SEE));
            ...
            cafetariaSets.add(new CafetariaSet("Sector + Dep", myJson,cafeTitle , cafeAll, cafeText, cafePrice, "cafetaria", MAX_TO_SEE));
